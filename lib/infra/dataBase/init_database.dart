...
// import 'DAO/bus_route_DAO.dart';
// import 'DAO/stop_bus_DAO.dart';
// import 'dataBaseHelper.dart';
//
// void main() async {
//   // Inicialize o banco de dados
//   DataBaseHelper dataBaseHelper = DataBaseHelper();
//   Database databaseInstance = await dataBaseHelper.initDatabase();
//
//   // Crie instâncias dos DAOs
//   BusRouteDAO busRouteDAO = BusRouteDAO(databaseInstance);
//   BusStopDAO busStopDAO = BusStopDAO(databaseInstance);
//
//   List<StopBus> busStopsList = [
//     StopBus(routeNumber: 628, stopBus: const LatLng(-22.755329,-47.4284943)),
//     StopBus(routeNumber: 628, stopBus: const LatLng(-22.754616,-47.4260924)),
//     StopBus(routeNumber: 628, stopBus: const LatLng(-22.7544808, -47.4233508)),
//     StopBus(routeNumber: 628, stopBus: stopBus)
//     // Adicione mais paradas de ônibus conforme necessário
//   ];
//
//   // Inserir dados de exemplo
//   await busRouteDAO.insertBusRoute(
//     BusRoute(
//         routeNumber: 622,
//         originInfo: const MapEntry<String, String>(
//             "Santa Bárbara d'Oeste", "Rodoterminal"),
...
// volta santa barbara sp-304 ate americana
...
// class StopBusMarkers {
//   final LatLng currentPosition;
//   final LatLng destination;
//   //final List<StopBusModel> stops;
//
//   const StopBusMarkers({
//     required this.currentPosition,
//     required this.destination,
//     // required this.stops,
//   });
//   factory StopBusMarkers.empty() {
//     return const StopBusMarkers(
...
//
//     // Adicione o marcador da localização atual
//     markers.add(
//       Marker(
...
//     );
//
//     // Adicione o marcador do destino
//     markers.add(
//       Marker(
...
//     );
//
//     // // Adicione os marcadores dos pontos de parada
//     // for (final stop in stops) {
//     //   markers.add(
//     //     Marker(
//     //       markerId: MarkerId(stop.id
//     //           .toString()), // Use um identificador único para cada marcador
//     //       position: LatLng(stop.stopBus.latitude, stop.stopBus.longitude),
//     //       infoWindow: InfoWindow(title: 'Ponto de Parada ${stop.id}'),
